...
public class HorarioController {
    ...
    @GetMapping
    public ResponseEntity<List<HorarioDTOs.Response>> obtenerTodos(@RequestParam(required = false, name = "activos") Boolean activos) {
        return ResponseEntity.ok(service.obtenerTodos(activos));
    }

    @GetMapping("/buscar")
    public ResponseEntity<List<HorarioDTOs.Response>> buscarPorNombre(
